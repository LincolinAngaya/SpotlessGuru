...
function BookingSteps() {
  ...
  <div className="flex flex-col items-center justify-center bg-white border border-sky-400 rounded-md p-6 shadow-lg transition-transform transform hover:bg-sky cursor-pointer">
        <img src={order} alt="order now" className="border border-sky rounded-full p-5 ring-2 ring-sky-400 "
     ...
     <div className="flex flex-col items-center justify-center bg-white border border-sky-400 rounded-md p-6 shadow-lg transition-transform transform hover:bg-sky cursor-pointer">
        <img src={come} alt="come now" className="border border-sky rounded-full p-5 ring-2 ring-sky-400"
        style={{ maxWidth: '120px' }} />
   ...
   <div className="flex flex-col items-center justify-center bg-white border border-sky-400 rounded-md p-6 shadow-lg transition-transform transform hover:bg-sky cursor-pointer">
      <img src={clean} alt="clean now" className="border border-sky rounded-full p-1 ring-2 ring-sky-400"
      style={{ maxWidth: '120px' }} />
  ...
  <div className="flex flex-col items-center justify-center bg-white border border-sky-400 rounded-md p-6 shadow-lg transition-transform transform hover:bg-sky cursor-pointer">
      <img src={happy} alt="happy now" className="border border-sky rounded-full p-5 ring-2 ring-sky-400 bg-white "
      style={{ maxWidth: '120px' }}/>
