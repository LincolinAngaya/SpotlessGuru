...
function BookingSteps() {
  ...
  <div className="flex flex-col items-center justify-center bg-white border border-sky rounded-md p-6 shadow-lg transition-transform transform hover:bg-sky cursor-pointer">
